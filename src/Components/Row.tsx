...
export const Row = ({ 
    ...
    <div
        className={`
            flex w-full p-4 mb-2 ml-auto mr-auto justify-between items-center
    ...
    >
        ...
        <div className="w-1/6 flex justify-between items-center mr-2">
            <button 
                ...
                className="h-7 w-7 flex justify-center items-center bg-red-400 hover:bg-red-700 text-white font-bold rounded"
